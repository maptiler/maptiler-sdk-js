...
export class Marker extends maplibregl.Marker {
   ...
   *
   * When `options.element` is provided it is used as-is for the marker
   * content; otherwise a styled SVG element is generated from the remaining
   * options.
  ...
  private cueMarkerElementUpdate(prop: keyof MapTilerMarkerElementProps, value: MapTilerMarkerElementProps[keyof MapTilerMarkerElementProps]) {
    ...
    MarkerManager.addMarkerUpdateToQue(this);
  }
