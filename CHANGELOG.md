...
- Legacy browser compatibility code targetting pre-2016 browsers and IE11 was removed from `maplibre-gl`
...
- Bumps `maplibre-gl` to 5.21.1
- Bumps `@maplibre/maplibre-gl-style-spec` to 24.7.0
